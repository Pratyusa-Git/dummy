                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            <h1>
                            Admin Dashboard<br>
                            <a href="<?php echo e(route('add_category')); ?>">Add Category</a><br>
                            <a href="<?php echo e(route('category_view')); ?>">Category View</a><br>
                            <a href="">Add Product</a><br>
                            <a href="<?php echo e(route('user_dashboard')); ?>">User Dashboard</a><br>
                        </h1>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\dummyproject\resources\views/admin_dashboard.blade.php ENDPATH**/ ?>